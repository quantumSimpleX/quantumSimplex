const socialLinks = [
  ...
  {
    href: 'https://www.youtube.com/@quantsimplex',
    label: 'YouTube',
  ...
  {
    href: 'https://scholar.google.com/citations?user=8lMkEWMAAAAJ&hl=en&authuser=1',
